    ...
    <span class="i-layout-header-trigger i-layout-header-trigger-min" @click="showSetting">
        ...
        <Drawer v-model="visible" width="280">
            ...
            <div class="i-layout-header-setting-item">
                <div class="i-layout-header-setting-item-radio" :class="{ 'on': siderTheme === 'light' }" @click="handleChangeSetting('siderTheme', 'light')">
                    <Tooltip content="亮色侧边栏" placement="top" transfer>
                        <span class="i-layout-header-setting-item-radio-span" style="border: 1px solid #ccc; background: #fff"></span>
                    </Tooltip>
                </div>
            ...
            <div class="i-layout-header-setting-item">
                ...
                <div class="i-layout-header-setting-item-radio" :class="{ 'on': headerTheme === 'purple' }" @click="handleChangeSetting('headerTheme', 'purple')">
                    <Tooltip content="酱紫顶栏" placement="top" transfer>
                        <span class="i-layout-header-setting-item-radio-span" style="background: #722ed1;"></span>
                    </Tooltip>
                </div>
            </div>
            ...
            <div class="i-layout-header-setting-item">
             ...
             <div class="i-layout-header-setting-item">
                <span class="i-layout-header-setting-item-desc">
                    显示顶部导航
                    <Tooltip placement="top" content="开启时面包屑导航无效" transfer>
                        <Icon type="ios-help-circle-outline" />
                    </Tooltip>
                </span>
                <span class="i-layout-header-setting-item-action">
