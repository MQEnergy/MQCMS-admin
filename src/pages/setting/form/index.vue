...
<script>
    ...
    import ComponentInput from "@/pages/setting/form/components/input";
    import ComponentRadioGroup from "@/pages/setting/form/components/radio_group";
    import ComponentCheckboxGroup from "@/pages/setting/form/components/checkbox_group";
    import ComponentDatepicker from "@/pages/setting/form/components/datepicker";
    import ComponentSelect from "@/pages/setting/form/components/select";
    import ComponentUpload from "@/pages/setting/form/components/upload";
    import ComponentSwitch from "@/pages/setting/form/components/switch";
    import ComponentRate from "@/pages/setting/form/components/rate";
    import ComponentDivider from "@/pages/setting/form/components/divider";
