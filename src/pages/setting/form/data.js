export default [
    {
        ...
        ele_attr: {
            ...
            readonly: false,
            maxlength: '', // 最大输入长度
            show_word_limit: '', // 是否显示输入字数统计，可以配合 maxlength 使用
            password: '', // 是否显示切换密码图标
    ...
    },
    {
        ...
        ele_attr: {
            ...
            transfer: false, // 是否将弹层放置于 body 内，在 Tabs、带有 fixed 的 Table 列内使用时，建议添加此属性，它将不受父级样式影响，从而达到更好的效果
            element_id: '',
            transfer_class_name: '', // 开启 transfer 时，给浮层添加额外的 class 名称
            prefix: '', // 在 Select 内显示图标
            max_tag_count: '', // 多选时最多显示多少个 tag
            max_tag_placeholder: '', // 隐藏 tag 时显示的内容，参数是剩余项数量
            allow_create: false, // 是否允许用户创建新条目，需开启 filterable
            capture: true, // 是否开启 capture 模式，也可通过全局配置
            option_disabled: false, // 是否禁用option当前项
