    ...
    <div>
        ...
        >
            ...
            <template slot-scope="{ row, index }" slot="action">
                <a @click="handleRoleMenusOpenUpdateCreate(true, row.id)">权限分配</a>
        ...
        <div class="ivu-mt ivu-text-center">
            <Page :total="total" show-total show-elevator :current.sync="current" @on-change="handleChange" />
        </div>
        <!-- 创建编辑 -->
        <create-form ref="createForm" @on-create-form="handleOpenUpdateCreate" @on-ok="getData" />
        <!-- 权限分配 -->
        <create-role-menus ref="createRoleMenus" @on-create-form="handleRoleMenusOpenUpdateCreate" @on-ok="getData" />
    </div>
</template>
<script>
import { RoleIndex, RoleSearch, RoleDelete } from '@/api/permission/role'
import searchForm from '@/components/searchform'
import createForm from './create-form'
import createRoleMenus from './create-role-menus'
...
export default {
    ...
    methods: {
        ...
        handleRoleMenusOpenUpdateCreate(status, updateIndex) {
            this.$refs.createRoleMenus.handleShowUpdateCreate(status, updateIndex)
        },
        handleDelete(index) {
